...
function activateDot(slideNumber) {
  document
    ...
    .forEach(dot => dot.classList.remove('dots__dot--active')); // First remove all the active classess

  document
    .querySelector(`.dots__dot[data-slide="${slideNumber}"]`) // Gets only the activated dot
